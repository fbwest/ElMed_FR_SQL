...
insert into @form values
	...
	('2.3.1', 'B18.2', null, null, 'B18.2', null, N'из них хронический вирусный гепатит C'),
	...
	('9.3.2', 'H81.0', null, null, 'H81.0', null, N'болезнь Mеньера'),
	...
	('10.6.6.1', 'I67.2', null, null, 'I67.2', null, N'из них:<br>церебральный атеросклероз'),
	...
	('17.0', 'P00-P04', null, null, 'P0[0-4]%', null, N'<b>отдельные состояния, возникающие в перинатальном' +
	                                                  N'периоде</b>'),
...
declare @tempTable table (DS1 nvarchar(10), ZSLID int, DATE_1 datetime, DN int, DS1_PR int, P_CEL nvarchar(3),
    DR datetime, NPOLIS nvarchar(20), W int, CODE_USL nvarchar(20))
...
select m.dsName, m.rowNum, m.ds,
	...
	-- 7 из них юноши
	count(distinct case when W = 1 then ZSLID end) as c7,
	...
	count(distinct case when DS1_PR = 1 and P_CEL = 2.1
	...
	count(distinct case when DS1_PR = 1 and P_CEL = 1.3
		and try_cast(CODE_USL as int) in (4,6,5,3004,3005,29,36) then ZSLID end) as c12,
	-- 13 впервые в жизни диагноз юноши (ед) - из 9
	count(distinct case when DS1_PR = 1 and W = 1 then ZSLID end) as c13,
	-- 14 снято с дн (чел)
	...
	count(distinct case when dnMax <= 2 and W = 1 then t.NPOLIS end) as c16
from @form m
