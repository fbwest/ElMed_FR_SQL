...
select
	count(distinct t.NPOLIS) as s1001_1,
	count(distinct case when DS1_PR = 1 then t.NPOLIS end) as s1001_2,
	count(distinct case when dnMax <= 2 then t.NPOLIS end) as s1001_3,
	count(distinct case when dnMax <= 2	and floor(datediff(day, DR, DATE_1) / 365.25) <= 4 then t.NPOLIS end) as s1002_1,
	count(distinct case when dnMax <= 2	and floor(datediff(day, DR, DATE_1) / 365.25) between 5 and 9 then t.NPOLIS end) as s1002_2,
	count(distinct case when dnMax <= 2	and (b18 > 0 and k74 > 0) then t.NPOLIS end) as s1003_1,
	count(distinct case when dnMax <= 2	and (b18 > 0 and c22 > 0) then t.NPOLIS end) as s1003_2,
	count(distinct case when DN = 2 and rowNum = '10.0' then t.NPOLIS end) as s1004_1,
	count(distinct case when DN = 2 and rowNum = '10.0' and dnMax >= 4 then t.NPOLIS end) as s1004_2
from @form m
