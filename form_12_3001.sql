...
select
	count(distinct t.NPOLIS) as s3002_1,
	count(distinct case when DS1_PR = 1 then t.NPOLIS end) as s3002_2,
	count(distinct case when dnMax <= 2 then t.NPOLIS end) as s3002_3,
	count(distinct case when dnMax <= 2	and (b18 > 0 and k74 > 0) then t.NPOLIS end) as s3003_1,
	count(distinct case when dnMax <= 2	and (b18 > 0 and c22 > 0) then t.NPOLIS end) as s3003_2,
	count(distinct case when DN = 2 and rowNum = '10.0' then t.NPOLIS end) as s3004_1,
	count(distinct case when DN = 2 and rowNum = '10.0' and dnMax >= 4 then t.NPOLIS end) as s3004_2
from @form m
