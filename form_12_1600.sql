...
insert into @form values
	...
	('1.1', 'Z00-Z13', 'Z00', 'Z13.9', null,
     N'из них:<br>обращения в медицинские организации для медицинского осмотра и обследования некоторые инфекционные и паразитарные болезни'),
	...
	('1.2', 'Z20-Z29', null, null, 'Z2[0-9]%',
     N'потенциальная опасность для здоровья, связанная с инфекционными болезнями'),
	...
	('1.4', 'Z40-Z54', 'Z40', 'Z54.9', null,
     N'обращения в медицинские организации в связи с необходимостью проведения специфических процедур и получения медицинской помощи'),
	...
	('1.5', 'Z55-Z65', 'Z55', 'Z65.9', null,
     N'потенциальная опасность для здоровья, связанная с социально-экономическими и психосоциальными обстоятельствами'),
	('1.6', 'Z70-Z76', null, null, 'Z7[0-6]%',
     N'обращения в медицинские организации в связи с другими обстоятельствами'),
	('1.6.1', 'Z72', null, null, 'Z72%', N'из них:<br>проблемы, связанные с образом жизни'),
	('1.7', 'Z80-Z99', 'Z80', 'Z99.9', null,
     N'потенциальная опасность для здоровья, связанная с личным или семейным анамнезом и определенными обстоятельствами, влияющими на здоровье'),
...
where (sl.DS1 <> '') and (sl.D3_ZSLID <> '') and (sc.ID <> '')
	and floor(datediff(day, p.DR, sl.DATE_1) / 365.25) < 1
