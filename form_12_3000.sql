...
insert into @form values
	...
	('3.2.1', 'D25', null, null, 'D25%', null, N'из них лейомиома матки'),
	...
	('15.6', 'N46', null, null, 'N46%', null, N'мужское бесплодие'),
	...
	('15.12', 'N97', null, null, 'N97%', null, N'женское бесплодие'),
	('16.0', 'O00-O99', null, null, 'O%', null, N'<b>беременность, роды и послеродовой период</b>'),
	('17.0', 'P00-P04', null, null, 'P0[0-4]%', null,
     N'<b>отдельные состояния, возникающие в перинатальном периоде</b>'),
...
declare @tempTable table (DS1 nvarchar(10), ZSLID int, DATE_1 datetime, DN int, DS1_PR int,
	P_CEL nvarchar(3), DR datetime, NPOLIS nvarchar(20), W int, CODE_USL nvarchar(20)) 
