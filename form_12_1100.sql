...
insert into @form values
	...
	('1.3', 'Z30-Z39', null, null, 'Z3%', N'обращения в медицинские организации в связи с обстоятельствами,' +
	                                      N'относящимися к репродуктивной функции'),
	...
	('1.4.1.1', 'Z50.2', null, null, 'Z50.2', N'из них:<br>реабилитация лиц, страдающих алкоголизмом'),
	('1.4.1.2', 'Z50.3', null, null, 'Z50.3', N'реабилитация лиц, страдающих наркоманиями'),
	('1.4.1.3', 'Z50.8', null, null, 'Z50.8', N'лечение, включающее другие виды реабилитационных процедур,' +
	                                          N'реабилитация при курении'),
	...
	('1.6', 'Z70-Z76', null, null, 'Z7[0-6]%', N'обращения в медицинские организации в связи с другими' +
	                                           N'обстоятельствами'),
	('1.6.1', 'Z71', null, null, 'Z71%', N'из них:<br>обращения в учреждения здравоохранения для получения других' +
	                                     N'консультаций и медицинских советов, не классифицированные в других рубриках'),
	('1.6.1.1', 'Z71.4', null, null, 'Z71.4', N'консультирование и наблюдение по поводу алкоголизма'),
	('1.6.1.2', 'Z71.5', null, null, 'Z71.5', N'консультирование и наблюдение по поводу наркомании'),
	('1.6.1.3', 'Z71.6', null, null, 'Z71.6', N'консультирование и наблюдение по поводу курения'),
	('1.6.2', 'Z72', null, null, 'Z72%', N'из них:<br>проблемы, связанные с образом жизни'),
	('1.6.2.1', 'Z72.0', null, null, 'Z72.0', N'из них:<br>употребление табака'),
	('1.6.2.2', 'Z72.1', null, null, 'Z72.1', N'употребление алкоголя'),
	('1.6.2.3', 'Z72.2', null, null, 'Z72.2', N'использование наркотиков'),
	('1.6.2.4', 'Z72.6', null, null, 'Z72.6', N'склонность к азартным играм и пари'),
