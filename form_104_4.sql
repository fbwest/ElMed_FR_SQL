...
insert into @formT values
	...
	('1.6.N', null, null, null, null, '<b>     Ишемическая болезнь сердца</b>'),
	...
	('1.16.N', null, null, null, null, '<b>     Цереброваскулярные болезни</b>'),
	...
	('2.1.N', null, null, null, null, '<b>     Злокачественные органов пищеварения</b>'),
	...
	('2.9.N', null, null, null, null, '<b>     Злокачественные органов дыхания</b>'),
	...
	('2.16.N', null, null, null, null, '<b>     Злокачественные женских половых органов</b>'),
	...
	('2.21.N', null, null, null, null, '<b>     Злокачественные мужских половых органов</b>'),
	...
	('2.23.N', null, null, null, null, '<b>     Злокачественные мочевыводящих органов</b>'),
	...
	('2.26.N', null, null, null, null, '<b>     Другие злокачественные новообразования кожи</b>'),
	...
	('4.4.N', null, null, null, null, '<b>     Пневмония</b>'),
	...
	('4.9.N', null, null, null, null, '<b>     Хронические заболевания нижних дыхательных путей</b>'),
	...
	('5.0.N', null, null, null, null, '<b>     Язва</b>'),
	...
	('5.8.N', null, null, null, null, '<b>     Болезни печени</b>'),
	...
	('5.11.N', null, null, null, null, '<b>     Желчно-каменная болезнь и холецистит</b>'),
...
insert into @form_sampleT
	...
	union all
	select 'Прочие болезни органов пищеварения', '5.15', 'K00-K14, K20-K24, R28, K30-K31, K55, K57-K66, K82, K83, K90-K93',
		sl_id, sl_povod, zsl_usl_ok, zsl_for_pom, usl_code_usl
	from @sampleT
...
select case when right(rowNum, 1) = 'N' then '' else rowNum end as rowNum, dsName, ds,
	...
	case when ds is not null then
		count(distinct case when zsl_usl_ok = 1 and zsl_for_pom = 3 then sl_id end)
	else null end as c5,
	-- стационар - экстренная госпитализация
	case when ds is not null then
		count(distinct case when zsl_usl_ok = 1 and zsl_for_pom = 1 then sl_id end)
	else null end as c6,
	-- стационарозамещ
	case when ds is not null then
		count(distinct case when zsl_usl_ok = 2 then sl_id end)
	else null end as c7,
	-- скорой вне МО
	case when ds is not null then
		count(distinct case when zsl_usl_ok = 4 then sl_id end)
	else null end as c8
from @form_sampleT
